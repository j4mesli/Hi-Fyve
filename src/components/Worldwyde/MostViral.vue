    ...
    <div class="worldwyde-wrapper">
        <div class="worldwyde-heading">
            <div class="worldwyde-heading-title">
                ...
                <h1 class="worldwyde-component-title">Most Viral Songs in {{ handleCountryName(props.individual_country!.country) }}</h1>
            ...
            <div class="dropdown-wrapper" :style="{ 
                ...
                <div :id="country.country === curr_country!.country ? 'current-country' : ''" class="dropdown-choice" :class="{ 'dropdown-active': country.country === curr_country!.country }" v-for="country in props.viral_countries" :key="country.id" @click="handleDropdown(country)" v-if="dropdown">
...
export default defineComponent({
    ...
    props: {
        viral_playlist: Object as PropType<Top50PlaylistContainer>,
        individual_country: Object as PropType<{ country: string, id: string }>,
        viral_countries: Object as PropType<Array<countryPlaylist>>,
    },
    components: {
        LoadingSpinnerVue,
    },
    setup(props, context) {
        ...
        const curr_country = ref(props.individual_country);
        ...
        watch(() => props.viral_playlist, (newValue) => {
            if (newValue) 
        ...
        const handleDropdown = (country?: { country: string, id: string }) => {
            ...
            if (country) {
                ...
                context.emit('newCountry', curr_country.value, 'viral');
            }
        }
        ...
        const getSongDescriptors = (index: number, song_features: SpotifyTrackAttributes) => {
            ...
            playlist.value[index] = (props.viral_playlist as Top50PlaylistContainer)[index];
        ...
        const getSongAttributes = async (start: number, end: number, checkBottom: boolean) => {
            if (props.viral_playlist) {
                if (!hideButton.value) hideButton.value = true;
                if (Object.keys(props.viral_playlist).length === 0) handleLogIn();
                else {
